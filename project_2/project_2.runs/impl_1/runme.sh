...
HD_PWD='C:/Users/Chris/Documents/development/ncat-ecen424-project2/project_2/project_2.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log digital_lock.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source digital_lock.tcl -notrace
